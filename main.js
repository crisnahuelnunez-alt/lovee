document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- LETRAS Y VARIABLES ---
    const lyrics = [
        { start: 20.5, end: 24.5, text: "PORQUE ERES UN CIELO LLENO DE ESTRELLAS" }, { start: 28.5, end: 31, text: "TE DARÉ MI CORAZÓN" }, { start: 35.5, end: 39.5, text: "PORQUE ERES UN CIELO LLENO DE ESTRELLAS" }, { start: 43.0, end: 45.5, text: "PORQUE ILUMINAS EL CAMINO" }, { start: 50.5, end: 54, text: "NO ME IMPORTA, ADELANTE, DESPEDÁZAME" }, { start: 58.0, end: 60, text: "NO ME IMPORTA SI LO HACES" }, { start: 65.5, end: 69.5, text: "PORQUE EN UN CIELO LLENO DE ESTRELLAS" }, { start: 70.5, end: 72.5, text: "CREO QUE TE VI" }, { start: 104.5, end: 108.5, text: "PORQUE ERES UN CIELO LLENO DE ESTRELLAS" }, { start: 112.0, end: 115.0, text: "ME QUIERO MORIR EN TUS BRAZOS" }, { start: 119.5, end: 123.0, text: "PORQUE CUANTO MÁS OSCURECE, MÁS TE ILUMINAS" }, { start: 126.5, end: 129.5, text: "TE DARÉ MI CORAZÓN" }, { start: 135.0, end: 138.5, text: "NO ME IMPORTA, ADELANTE, DESPEDÁZAME" }, { start: 142.5, end: 144.5, text: "NO ME IMPORTA SI LO HACES" }, { start: 150.0, end: 154.0, text: "PORQUE EN UN CIELO LLENO DE ESTRELLAS" }, { start: 154.5, end: 157.0, text: "CREO QUE TE VEO" }, { start: 204.0, end: 208.0, text: "ERES UN CIELO LLENO DE ESTRELLAS" }, { start: 208.5, end: 211.5, text: "UNA VISIÓN TAN CELESTIAL" }
    ];
    ...
    // --- LÓGICA DEL PROYECTO (MINIFICADA PARA EFICIENCIA) ---
    ...
    function setupAudioAnalysis(){if(isAudioSetup)return;audioContext=new(window.AudioContext||window.webkitAudioContext),analyser=audio-circulatory system.createAnalyser(),analyser.fftSize=256,source=audioContext.createMediaElementSource(audioPlayer),source.connect(analyser),source.connect(audioContext.destination),dataArray=new Uint8Array(analyser.frequencyBinCount),isAudioSetup=!0,updateFrame()}
